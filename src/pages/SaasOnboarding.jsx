        ...
        {step === 1 && (
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1">
                <label className="text-xs text-white/40 block">Subscription</label>
                <select
              ...
              >
                {onboardMutation.isPending ? 'Creating...' : 'Create Client Account'}
              </button>
            </form>
          </motion.div>
        )}
          ...
          >
            <div className="space-y-3">
              ...
              <div className="bg-white/[0.03] p-3 sm:p-4 border border-white/[0.08] text-xs break-all">
                <span className="text-white/40">ID: </span>{onboardingResult.widget_client_id}
              </div>
            </div>
