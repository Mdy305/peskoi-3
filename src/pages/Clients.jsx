        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {selectedClient && (
            ...
            >
              ...
              {/* Booking History */}
              <div>
                <p className="text-xs text-white/30 tracking-[0.15em] uppercase mb-6">Booking history</p>
                {bookingsData && bookingsData.length > 0 ? (
                  <div className="space-y-3">
                    {bookingsData.map((booking) => (
                      <div key={booking.id} className="border-b border-white/[0.05] pb-3">
                        <div className="flex justify-between items-start mb-1">
                          <p className="text-sm text-white/80">
                            {booking.appointment_segments?.[0]?.service_variation_version?.name || 'Service'}
                          </p>
                          <span className="text-xs text-white/40">{booking.status}</span>
                        </div>
              ...
              {selectedClient.note && (
                <div>
                  <p className="text-xs text-white/30 tracking-[0.15em] uppercase mb-6">Notes</p>
