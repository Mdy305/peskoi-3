...
export default function ProductIntelligence() {
  ...
  const analyzeMutation = useMutation({
    mutationFn: () =>
      base44.functions.invoke("analyzeProductRecommendations", {}),
    onSuccess: () => {
  ...
  const sendMutation = useMutation({
    mutationFn: (recommendation_id) =>
      base44.functions.invoke("sendProductRecommendation", {
        recommendation_id,
      }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["productRecommendations"] });
              ...
              <Card className="bg-[#141414] border-[#1f1f1f]">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-500">
                    No pending product recommendations
                  </p>
                </CardContent>
              </Card>
            ) : (
                    ...
                    <Card className="bg-[#141414] border-[#1f1f1f]">
                      <CardHeader>
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                          ...
                          <Badge
                            className={`${statusColors[rec.status]} border`}
                          >
                            {rec.status}
                          </Badge>
                        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-1 text-gray-300 text-sm">
                  <p>
                    ✓ Waits 2-6 hours (short services) or 12-24 hours
                    (color/treatments)
                  </p>
                  <p>✓ Maximum 1-2 products per recommendation</p>
                  <p>
                    ✓ Automatically stops after 2 ignored messages (60-day
                    pause)
                  </p>
