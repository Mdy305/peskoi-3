...
export default function SaasClientAutomations() {
  ...
  const { data: scheduled = [] } = useQuery({
    ...
    queryFn: () =>
      base44.entities.ScheduledCommunication.filter({
        saas_client_id: selectedClient,
        status: "pending",
      }),
    enabled: !!selectedClient,
  ...
  const updateMutation = useMutation({
    mutationFn: (data) =>
      base44.entities.ClientAutomationSettings.update(settings.id, data),
    onSuccess: () => {
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/40 mt-1">
                    Send reminder before appointments
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleToggle("reminder_enabled", !settings.reminder_enabled)
                  }
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdate("reminder_template", e.target.value)
                      }
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <button
                  onClick={() =>
                    handleToggle("feedback_enabled", !settings.feedback_enabled)
                  }
                  className={`px-3 py-1 text-xs border transition-colors ${
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdate("feedback_template", e.target.value)
                      }
                      className="w-full bg-transparent border border-white/[0.08] p-3 text-sm focus:outline-none focus:border-white/20 h-20"
                    />
                    <p className="text-xs text-white/30 mt-2">
                      Use: {`{name}, {service}, {link}`}
                    </p>
                  </div>
                </div>
              )}
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/40 mt-1">
                    Send special offers on birthdays
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleToggle("birthday_enabled", !settings.birthday_enabled)
                  }
                  className={`px-3 py-1 text-xs border transition-colors ${
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleUpdate("birthday_offer", e.target.value)
                      }
                      className="w-full bg-transparent border-b border-white/[0.08] pb-2 text-sm focus:outline-none focus:border-white/20"
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2 max-h-48 overflow-y-auto border border-white/[0.08] p-3">
                        {catalog.items.map((item) => (
                          <label
                            key={item.id}
                            className="flex items-center gap-2 text-xs cursor-pointer hover:bg-white/[0.02] p-1"
                          >
                            <input
                              type="checkbox"
                              checked={(
                                settings.birthday_services || []
                              ).includes(item.id)}
                              onChange={(e) => {
                                const services =
                                  settings.birthday_services || [];
                      ...
                      <p className="text-xs text-white/30 mt-2">
                        Select services to feature in birthday offers
                      </p>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleUpdate("birthday_template", e.target.value)
                      }
                      className="w-full bg-transparent border border-white/[0.08] p-3 text-sm focus:outline-none focus:border-white/20 h-20"
                    />
                    <p className="text-xs text-white/30 mt-2">
            ...
            >
              ...
              <select
                ...
                onChange={(e) =>
                  handleUpdate("communication_channel", e.target.value)
                }
                className="w-full bg-black border border-white/[0.08] px-4 py-3 text-sm focus:outline-none focus:border-white/20"
              >
              ...
              <div>
                ...
                <div className="space-y-2">
                  {scheduled.slice(0, 5).map((comm, i) => (
                    <div
                      key={comm.id}
                      className="border-b border-white/[0.05] pb-2 text-xs"
                    >
                      <p className="text-white/80">
                        {comm.customer_name} - {comm.communication_type}
                      </p>
