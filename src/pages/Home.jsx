...
export default function Home() {
  ...
  const { data: bookingsData, isLoading: bookingsLoading } = useQuery({
    ...
    enabled:
      step === "READY" &&
      (currentPage === "Activity" || currentPage === "Appointments"),
    refetchOnWindowFocus: false,
    retry: false,
  });
  ...
  const { data: servicesData } = useQuery({
    ...
    enabled:
      step === "READY" &&
      (currentPage === "Services" || currentPage === "Settings"),
    refetchOnWindowFocus: false,
    retry: false,
  });
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="text-sm opacity-90">
                          {booking.customer_id
                            ? `Client ${booking.customer_id.slice(0, 8)}`
                            : "Walk-in"}
                        </p>
                        ...
                        {booking.appointment_segments?.[0]
                          ...
                          <p className="text-xs opacity-40 mt-2">
                            {booking.appointment_segments[0].service_variation_id.slice(
                              0,
                              16,
                            )}
                          </p>
            ...
            {!customersData ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs opacity-30">
                  Square customers will appear here
                </p>
              </div>
            ) : (
        ...
        {currentPage === "Settings" && (
          <section className="animate-fade">
            ...
            <div className="space-y-16">
              <div>
                <h2 className="text-xs opacity-30 mb-6 tracking-widest">
                  SERVICES
                </h2>
                <button
                ...
                >
                  {syncServicesMutation.isLoading
                    ? "Syncing..."
                    : "Sync from Square"}
                </button>
